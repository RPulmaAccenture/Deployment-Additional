...
(
 ...
 --------------------------------------------------------------------------------------------
  ...
  17-Feb-2015		   Erwin Ramos		Updated the p_reprocess to UPPER case to address case sensitive.
										Modified get dbLink as a cursor
  13-Mar-2015		   Albert Flores	Addressed defect 124 - additional criteria for the instance id									
  */
  --------------------------------------------------------------------------------------------
  ...
  v_instance_id			  MSC_APPS_INSTANCES.INSTANCE_ID%TYPE; --3/13/2015 A Flores - Defect 124
  ...
  SELECT mai.M2A_DBLINK
		,mai.instance_id -- 3/13/2015 A Flores - Defect 124  
...
BEGIN
  -- Get DB Link from VCP to EBS
  OPEN c_dbLink;
  FETCH c_dbLink INTO dbLink , v_instance_id; -- 3/13/2015 A Flores - Defect 124
  CLOSE c_dbLink;
  

-- Query string for cursor to get the data from EBS and concatenate to the Item description in VCP.
-- 3/13/2015 A Flores Added the v_instance_id
